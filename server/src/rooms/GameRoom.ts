...
const MAX_MOBS  = 25;
const MOB_TYPES = ["pig", "pig", "pig", "chicken", "chicken", "zombie", "cow", "cow", "sheep", "sheep", "creeper", "skeleton", "spider", "witherskeleton", "wolf", "cat"] as const;
...
export class GameRoom extends Room<GameState> {
  ...
  private spawnMob(type?: string) {
    ...
    mob.maxHealth = mobType === "zombie" ? 20 : mobType === "creeper" ? 20 : mobType === "skeleton" ? 20 : mobType === "witherskeleton" ? 40 : mobType === "chicken" ? 4 : mobType === "cow" ? 16 : mobType === "sheep" ? 12 : mobType === "spider" ? 16 : mobType === "wolf" ? 20 : mobType === "cat" ? 10 : 10;
