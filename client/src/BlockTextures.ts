...
function getOrCreateWaterMat(): THREE.MeshLambertMaterial {
  ...
  _waterMat = new THREE.MeshLambertMaterial({
    ...
    transparent: true,
    opacity: 0.80,
    depthWrite: true,    // MUST be true — prevents back-face bleed-through
    alphaTest: 0,
